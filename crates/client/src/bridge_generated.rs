...
pub(crate) const FLUTTER_RUST_BRIDGE_CODEGEN_CONTENT_HASH: i32 = -1984851438;
...
fn pde_ffi_dispatcher_primary_impl(
    ...
    match func_id {
        ...
        2 => wire__crate__api__add_contact_with_nickname_impl(port, ptr, rust_vec_len, data_len),
        3 => wire__crate__api__append_local_message_impl(port, ptr, rust_vec_len, data_len),
        4 => {
            wire__crate__api__decrypt_message_from_envelope_impl(port, ptr, rust_vec_len, data_len)
        }
        5 => wire__crate__api__encrypt_message_for_identity_impl(port, ptr, rust_vec_len, data_len),
        6 => wire__crate__api__get_account_id_impl(port, ptr, rust_vec_len, data_len),
        7 => wire__crate__api__get_account_pubkey_impl(port, ptr, rust_vec_len, data_len),
        8 => wire__crate__api__get_pubkey_tls_impl(port, ptr, rust_vec_len, data_len),
        9 => wire__crate__api__list_contacts_json_impl(port, ptr, rust_vec_len, data_len),
        10 => wire__crate__api__load_local_history_impl(port, ptr, rust_vec_len, data_len),
        11 => wire__crate__api__login_and_fetch_history_tls_impl(port, ptr, rust_vec_len, data_len),
        12 => wire__crate__api__login_and_load_local_history_tls_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        13 => wire__crate__api__login_tls_impl(port, ptr, rust_vec_len, data_len),
        14 => wire__crate__api__open_message_stream_register_tls_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        15 => wire__crate__api__open_message_stream_tls_impl(port, ptr, rust_vec_len, data_len),
        16 => {
            wire__crate__api__register_and_fetch_history_tls_impl(port, ptr, rust_vec_len, data_len)
        }
        17 => wire__crate__api__register_and_load_local_history_tls_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        18 => wire__crate__api__register_tls_impl(port, ptr, rust_vec_len, data_len),
        19 => wire__crate__api__send_direct_message_over_stream_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        20 => wire__crate__api__send_direct_message_over_stream_to_identity_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        21 => wire__crate__api__send_direct_message_tls_impl(port, ptr, rust_vec_len, data_len),
        22 => wire__crate__api__send_media_to_identity_impl(port, ptr, rust_vec_len, data_len),
        23 => wire__crate__api__set_contact_nickname_impl(port, ptr, rust_vec_len, data_len),
        24 => wire__crate__api__set_pubkey_over_stream_impl(port, ptr, rust_vec_len, data_len),
        _ => unreachable!(),
    }
}
